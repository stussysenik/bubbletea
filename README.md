...
<!-- zig-rewrite:start -->
- Status: `active`
- Rewrite Summary: A Zig-native Bubble Tea rewrite that starts headlessly, renders to terminal today, and now includes protocol-aware terminal input, form-driven UI primitives, and a static browser host that drives the same runtime through WASM.
